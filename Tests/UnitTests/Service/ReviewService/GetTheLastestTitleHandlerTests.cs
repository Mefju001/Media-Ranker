...
namespace Tests.Service.ReviewService
{
    ...
    public class GetTheLastestTitleHandlerTests
    {
        ...
        private GetTheLastestTitleHandler GetTheLastestHandler;
        [TestInitialize]
        public async Task Setup()
        {
            ...
            GetTheLastestHandler = new GetTheLastestTitleHandler(appDbContext);
        }
        [TestCleanup]
        public void Cleanup()
        {
        ...
        {
            await SeedData();
            var result = await GetTheLastestHandler.Handle(new GetTheLastestTitleQuery(), CancellationToken.None);
