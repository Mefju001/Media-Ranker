...
namespace Domain.Specification
{
    public class MovieFilterSpecification : BaseSpecification<Movie>
    {
        ...
        public MovieFilterSpecification(string? TitleSearch, double? MinRating, int? ReleaseYear,
        List<Guid>? genreIds, List<Guid>? directorIds,
        string? SortByField, bool IsDescending)
        {
            ...
            {
                AddCriteria(m => directorIds.Contains(m.DirectorId));
            }
