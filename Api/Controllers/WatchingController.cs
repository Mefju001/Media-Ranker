...
using Application.Features.Watching.Add;
using Application.Features.Watching.DeleteById;
using Application.Features.Watching.GetAll;
using MediatR;
...
namespace Api.Controllers
{
    ...
    public class WatchingController:ControllerBase
    {
        ...
        public WatchingController(IMediator mediator, ICurrentUserContext currentUserContext)
        {
