...
namespace Application.Features.TvSeries.AddRange
{
    ...
    public class AddRangeHandler : IRequestHandler<AddRangeCommand, List<TvSeriesResponse>>
    {
        ...
        public AddRangeHandler(IMediator mediator, IGenreHelperService genreHelperService, IMediaRepository<domain.TvSeries> mediaRepository)
        {
