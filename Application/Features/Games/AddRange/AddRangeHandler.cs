...
namespace Application.Features.Games.AddRange
{
    ...
    public class AddRangeHandler : IRequestHandler<AddRangeCommand, List<GameResponse>>
    {
        private readonly IGenreHelperService genreHelperService;
        private readonly IMediaRepository<Game> mediaRepository;
        private readonly IMediator mediator;
        public AddRangeHandler(IMediator mediator, IGenreHelperService genreHelperService, IMediaRepository<Game> mediaRepository)
        {
