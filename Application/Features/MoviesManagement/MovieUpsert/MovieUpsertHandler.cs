...
{
    public class GameUpsertHandler : IRequestHandler<UpsertGameCommand, MovieResponse>
    {
        ...
        public GameUpsertHandler(IUnitOfWork unitOfWork, IReferenceDataService referenceDataService, IMovieBuilder movieBuilder, IMediator mediator)
        {
        ...
        public async Task<MovieResponse> Handle(UpsertGameCommand request, CancellationToken cancellationToken)
        {
